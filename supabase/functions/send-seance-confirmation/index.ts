...
serve(async (req) => {
  const { email, prenom, nom, date_seance, heure_seance, duree_minutes, type_seance, praticien } = await req.json()
...
<body style="margin:0;padding:0;background:#F5F0E8;font-family:Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#F5F0E8;padding:40px 0;">
    <tr><td align="center">
        ...
        <tr><td style="padding:24px 40px;">
          <div style="background:#F0F9FF;border-radius:12px;padding:20px;border:0.5px solid #BAE6FD;">
            <table width="100%" cellpadding="0" cellspacing="0">
              ...
              <tr><td style="padding:6px 0;font-size:13px;color:#6b7280;">👤 Praticien</td><td style="padding:6px 0;font-size:13px;font-weight:600;color:#111827;text-align:right;">${praticien || '—'}</td></tr>
            </table>
          </div>
        </td></tr>
        <tr><td style="padding:0 40px 32px;text-align:center;">
          <p style="margin:0;font-size:13px;color:#9CA3AF;">Une question ? Contactez directement votre praticien.</p>
        </td></tr>
      ...
      <p style="margin:16px 0 0;font-size:11px;color:#9CA3AF;text-align:center;">© 2026 Naposolo · naposolo.com</p>
    </td></tr>
  </table>
</body>
</html>`
