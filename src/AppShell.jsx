...
const NouvelleSeanceEnergeticien = lazy(() => import('./pages/NouvelleSeanceEnergeticien'))
const EditSeanceEnergeticien = lazy(() => import('./pages/EditSeanceEnergeticien'))
...
const ALL_SB_ITEMS = [
  ...
  { id: 'chakras',     label: 'Chakras',        icon: 'ti-yin-yang',       to: '/chakras'                        },
        ...
        <main className="main">
          <ChunkErrorBoundary><Suspense fallback={<div style={{padding:'2rem',color:'#666'}}>Chargement...</div>}>
            <Routes>
              ...
              <Route path="/chakras/nouvelle" element={<NouvelleSeanceEnergeticien />} />
              <Route path="/chakras/edit/:clientId" element={<EditSeanceEnergeticien />} />
              <Route path="/chakras/edit/:clientId/:seanceId" element={<EditSeanceEnergeticien />} />
