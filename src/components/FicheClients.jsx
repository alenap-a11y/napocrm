...
function exportCSV(clients) {
  const header = 'nom,prenom,genre,telephone,email'
...
export default function FicheClients({ userId }) {
  ...
  async function saveDetail() {
    setSaving(true)
    const payload = { user_id: userId, nom: fNom.trim(), prenom: fPrenom.trim(), genre: fGenre, telephone: fTel.trim(), email: fEmail.trim(), notes: fNotes.trim() }
