      ...
      {detail && (
        <div style={{ width: 300, flexShrink: 0, display: 'flex', flexDirection: 'column', gap: 10, overflowY: 'auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <button onClick={() => { setDetail(null); window.location.hash = `/fleurs-de-bach/${detail.id}`; }} style={{ padding: '7px 14px', borderRadius: 8, background: '#3D5A3E', color: 'white', border: 'none', cursor: 'pointer', fontSize: 12, fontWeight: 600 }}>🌿 Fleurs de Bach</button>
